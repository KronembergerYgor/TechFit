...
function FourthSession() {
      ...
      const infosButtons = [
      {
        ...
        descricao: "Organize seus horários e otimize seu tempo"
      },
      {
        id: randomNumber(),
        icone: <FaMoneyBillTrendUp size={sizeIcons} />,
        titulo: "Gestão Financeira",
        descricao: "Tenha controle total de seus ganhos e recebimentos"
      },
      {
        id: randomNumber(),
        icone: <FaClipboardList size={sizeIcons} />,
        titulo: "Planos de treinos",
        descricao: "Crie e personalize treinos livremente"
      },
    ];
  ...
  return <>
    <div className="containers">
        ...
        <h3 className='titleSecondSession'> <span style={{color: '#000000'}}> <span style={{color: "#db8300"}} >PROFESSORES: </span> ESCALABILIDADE E PRODUTIVIDADE </span> </h3>
